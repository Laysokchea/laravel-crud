          ...
          <div class="row w-100">
            <div class="col-lg-4 mx-auto">
              ...
              <div class="auto-form-wrapper">
                ...
                <form action="<?php echo e(route('auth.register.process')); ?>" method="POST">
                  <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?> " name="name" placeholder="Username">
...
unset($__errorArgs, $__bag); ?>" name="confirm_password" placeholder="Confirm Password">
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="text-block text-center my-3">
                    ...
                    <a href="<?php echo e(route('auth.show.login')); ?>" class="text-black text-small">Login</a>
                  </div>
                </form>
              </div>
            </div>
...
</html><?php /**PATH /Users/mac/Desktop/product_crud/resources/views/register.blade.php ENDPATH**/ ?>