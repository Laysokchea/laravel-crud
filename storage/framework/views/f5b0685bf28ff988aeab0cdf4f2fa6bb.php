...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="form-group">
                    <button class="btn btn-block g-login">
                      <img class="mr-3" src="<?php echo e(asset('assets/images/file-icons/icon-google.svg')); ?>" alt="">Log in with Google</button>
                  </div>
                  <div class="text-block text-center my-3">
                    <span class="text-small font-weight-semibold">Not a member ?</span>
                    <a href="<?php echo e(route('auth.show.register')); ?>" class="text-black text-small">Create new account</a>
                  </div>
                </form>
              </div>
...
</html><?php /**PATH /Users/mac/Desktop/product_crud/resources/views/login.blade.php ENDPATH**/ ?>